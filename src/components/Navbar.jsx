...
const Navbar = () => {
  ...
  return (
    <nav className="bg-gradient-to-r from-purple-900 via-indigo-900 to-blue-900 backdrop-blur-lg border-b border-purple-500/20 sticky top-0 z-50 bg-opacity-80 h-14">
