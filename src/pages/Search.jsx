...
const ModernSearch = () => {
  ...
  const ListView = () => (
    <div className="space-y-4">
      {results.map((movie) => (
        <div key={movie.id} className="bg-gradient-to-r from-black/70 to-gray-900/70 backdrop-blur-md rounded-2xl border border-gray-700/50 hover:border-purple-500/70 transition-all duration-300 overflow-hidden">
          <div className="flex">
  ...
  const CompactView = () => (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
      {results.map((movie) => (
        <div key={movie.id} className="bg-gradient-to-r from-black/70 to-gray-900/70 backdrop-blur-md rounded-xl border border-gray-700/50 hover:border-purple-500/70 transition-all duration-300 p-4">
              ...
              <div className="flex items-center gap-4">
                <div className="flex items-center gap-2 bg-black/50 backdrop-blur-md rounded-lg p-1 border border-gray-700/50">
                  <button
                    ...
                    className={`p-2 rounded-md transition-all ${viewMode === 'grid' ? 'bg-purple-600 text-white' : 'text-gray-300 hover:text-white hover:bg-white/10'}`}
                  >
                    <Grid className="w-5 h-5" />
                  </button>
                  <button
                    onClick={() => setViewMode('list')}
                    className={`p-2 rounded-md transition-all ${viewMode === 'list' ? 'bg-purple-600 text-white' : 'text-gray-300 hover:text-white hover:bg-white/10'}`}
                  >
                    <List className="w-5 h-5" />
                  </button>
                  <button
                    onClick={() => setViewMode('compact')}
                    className={`p-2 rounded-md transition-all ${viewMode === 'compact' ? 'bg-purple-600 text-white' : 'text-gray-300 hover:text-white hover:bg-white/10'}`}
                  >
